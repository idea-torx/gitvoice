...
const DEFAULT_LOGO_DATA_URI = "data:image/svg+xml;base64,";
...
.invoice-logo { width: 8mm; height: 8mm; object-fit: contain; display: block; }
...
function renderCoverPage(invoice: InvoiceDraft | InvoiceRecord): string {
  ...
  return `<section class="invoice-page cover-page"><div class="page-inner">
    ...
    ${summary.notes ? `<section class="notes-card"><p class="label">Work description</p><div class="notes-copy">${escapeHtml(summary.notes)}</div></section>` : ""}
    ${"manualDescription" in invoice && invoice.manualDescription ? `<section class="notes-card"><p class="label">Special billing description</p><div class="notes-copy">${escapeHtml(invoice.manualDescription)}</div></section>` : ""}
